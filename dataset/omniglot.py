...
class Omniglot(VisionDataset):
    ...
    def __init__(
        ...
        self.data_targets = [[(self.load_image(image, idx), idx) for image in list_files(join(self.target_folder, character), '.png')]
                                  for idx, character in enumerate(self.characters)]
        self.data_targets = sum(self.data_targets, [])
        self.data = [x for x, _ in self.data_targets]
        self.targets = [y for _, y in self.data_targets]
        self.labels = self.targets
        self.classes = self.characters

    def load_image(self, image_name, character_class):
        image_path = join(self.target_folder, self.characters[character_class],
                          image_name)
